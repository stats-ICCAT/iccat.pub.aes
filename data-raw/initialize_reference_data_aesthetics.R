...
REF_SPECIES_GEAR_GROUPS_COLORS[SPECIES_GEAR_GROUP == "Traps",         FILL := REF_GEAR_GROUPS_COLORS[GEAR_GROUP_CODE == "TR"]$FILL]
REF_SPECIES_GEAR_GROUPS_COLORS[SPECIES_GEAR_GROUP == "Trawl",         FILL := REF_GEAR_GROUPS_COLORS[GEAR_GROUP_CODE == "TW"]$FILL]
REF_SPECIES_GEAR_GROUPS_COLORS[SPECIES_GEAR_GROUP == "Troll",         FILL := REF_GEAR_GROUPS_COLORS[GEAR_GROUP_CODE == "TL"]$FILL]
